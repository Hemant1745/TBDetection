    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: '#0A0A0A' }}>
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-light text-white" style={{ fontFamily: 'Outfit' }}>Create your account</h1>
          <p className="text-sm text-slate-400 mt-1">Start analyzing X-rays with AI</p>
        </div>

        <div className="glass-card p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            {error && (
              <div data-testid="register-error" className="p-3 rounded-lg bg-red-500/10 border border-red-500/20 text-red-400 text-sm">
                {error}
              </div>
            )}
        ...
        <p className="text-center text-sm text-slate-400 mt-6">
          ...
          <Link to="/login" data-testid="goto-login-link" className="text-[#00E5FF] hover:underline">
            Sign in
          </Link>
        </p>
      </motion.div>
